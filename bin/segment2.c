...
ALIGNED8 static const Texture texture_hud_char_souls[] = {
#include "textures/segment2/segment2.souls.rgba16.inc.c"
};
...
const Texture *const main_hud_lut[] = {
    ...
    texture_hud_char_apostrophe, texture_hud_char_double_quote, texture_hud_char_umlaut, texture_hud_char_souls,
};
